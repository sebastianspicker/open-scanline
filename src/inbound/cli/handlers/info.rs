use crate::domain::manufacturers::manufacturer_support_summary;
use crate::inbound::cli::args::InfoModule;
use crate::inbound::diagnostics::feature_matrix;
use crate::inbound::diagnostics::ml_module_info;
use crate::inbound::host::twain_shim_info;
use crate::infrastructure::acquisition::{list_all_devices, list_backends};
use crate::infrastructure::media::ocr::ocr_module_info;
