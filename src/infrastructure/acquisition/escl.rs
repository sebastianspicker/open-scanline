...
"#,
    ...
    fn decode_document(
            ...
            && (image.width != target_width || image.height != target_height)
        {
            ...
            image = super::file::FileDeviceSession::resize_nearest(
                &image,
                target_width,
                target_height,
            )?;
...
impl DeviceSession for EsclDeviceSession {
    fn scan(&self, request: &ScanRequest) -> Result<ImageBuffer> {
        ...
        if self.simulate {
            return super::mock::MockDeviceSession::gradient(request);
        }
    ...
    fn scan_pages(
        ...
        if self.simulate {
            for index in 0..max_pages {
                ...
                emit(super::mock::MockDeviceSession::gradient(&page_request)?)?;
            }
