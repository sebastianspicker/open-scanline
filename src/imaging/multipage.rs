...
use crate::imaging::codecs::buffer_to_dynamic;
use crate::imaging::{load_image, save_image_with_cancellation};
use image::Rgb;
...
pub fn save_index_contact_sheet_with_cancellation(
    ...
    let height = rows
        ...
        .ok_or_else(|| ScanError::Invalid("contact sheet dimensions overflow".into()))?;
    crate::core::checked_image_len(width, height, PixelFormat::Rgb8.bpp())?;
