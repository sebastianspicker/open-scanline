...
fn parse_saturation(value: &str) -> Result<f64, String> {
    ...
    crate::config::validate_saturation(value).map_err(|error| error.to_string())
}
...
fn parse_hue(value: &str) -> Result<f64, String> {
    ...
    crate::config::validate_hue(value).map_err(|error| error.to_string())
}

fn parse_curves(value: &str) -> Result<CurvePoints, String> {
    crate::config::parse_curve_points(value)
...
impl ScanSource {
    pub(super) fn mode(self) -> crate::core::ScanMode {
        match self {
            Self::Flatbed => crate::core::ScanMode::Reflective,
            Self::Adf => crate::core::ScanMode::Document,
            Self::Film => crate::core::ScanMode::Film,
        }
    }
}
...
impl OnnxLayout {
    pub(super) fn as_ml(self) -> crate::ml::OnnxInputLayout {
        match self {
            Self::Auto => crate::ml::OnnxInputLayout::Auto,
            Self::Nchw => crate::ml::OnnxInputLayout::Nchw,
            Self::Nhwc => crate::ml::OnnxInputLayout::Nhwc,
        }
    }
}
...
impl OnnxNormalization {
    pub(super) fn as_ml(self) -> crate::ml::OnnxNormalization {
        match self {
            Self::ZeroToOne => crate::ml::OnnxNormalization::ZeroToOne,
            Self::None => crate::ml::OnnxNormalization::None,
        }
    }
}
